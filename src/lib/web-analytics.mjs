...
export const pages = new Set(['/', '/practice/', '/get/meta_guess/', '/get/meta_between/', '/get/meta_heard/', '/get/meta_audio_round_v1/', '/get/ig_one_round_20260928/', '/get/partner_one_round_20260928/', '/es/', '/fr/', '/de/', '/nl/', '/pt-br/', '/he/', '/try/', '/privacy/', '/terms/', '/support/', '/press/', '/PrivacyPolicy/', '/TermsAndConditions/']);
